...
| **Scale** | <!--count:tables-->42<!--/count--> tables · <!--count:policies-->75<!--/count--> RLS policies · <!--count:dbFunctions-->113<!--/count--> database functions · <!--count:tests-->1,263<!--/count--> tests · 12 markets |
...
- **<!--count:tests-->1,263<!--/count--> tests** across <!--count:testFiles-->78<!--/count--> files (`npm test`), weighted toward the highest-risk
