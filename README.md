...
| **Scale** | <!--count:tables-->41<!--/count--> tables · <!--count:policies-->75<!--/count--> RLS policies · <!--count:dbFunctions-->105<!--/count--> database functions · <!--count:tests-->1,097<!--/count--> tests · 12 markets |
...
and implemented as <!--count:components-->76<!--/count--> components. No component library: a bought design system
...
**<!--count:sourceFiles-->215<!--/count-->** source files · **<!--count:testFiles-->66<!--/count-->** test files.
...
- **<!--count:tests-->1,097<!--/count--> tests** across <!--count:testFiles-->66<!--/count--> files (`npm test`), weighted toward the highest-risk
...
| [`docs/brand-mark.md`](docs/brand-mark.md) | The official logo files, the standalone symbol, the favicon and app-icon system, and how to use them |
